...
const charactersTexture = new CharactersTexture('Hi Dhamith');
const charactersPositionMap = new CharactersPositionMap('Hi Dhamith', CHAR_MAP_SIZE_W, CHAR_MAP_SIZE_H)
